...
class BaseParserModel(BaseModel):
    ...
    @staticmethod
    def interesting_list(text: str) -> List[float]:
    ...
    @staticmethod
    def get_id_from_href(text: str) -> str | None:
        if text:
